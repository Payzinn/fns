...
class TaxDocument(models.Model):
    ...
    kpp_organ = models.CharField(max_length=10, null=True, blank=True)  
    ...
    desc_nal_stav = models.CharField(max_length=50, null=True, blank=True) 
    ...
    per_nal_stav = models.CharField(max_length=50, null=True, blank=True)  
    ...
    sved_nal_lgot = models.CharField(max_length=50, null=True, blank=True)  
    ...
    sved_nal_vych = models.CharField(max_length=50, null=True, blank=True)  
    size_nv = models.CharField(max_length=255, null=True, blank=True)
    sv_osob_opr = models.CharField(max_length=10, null=True, blank=True)  
    sv_data_nach = models.CharField(max_length=10, null=True, blank=True)  
    sv_otm_upl = models.CharField(max_length=10, null=True, blank=True)  
    kod_ust_srok = models.CharField(max_length=50, null=True, blank=True)  
    ust_srok = models.CharField(max_length=50, null=True, blank=True)
    type_inf_doc = models.CharField(max_length=50, null=True, blank=True)  
    type_nal = models.CharField(max_length=50, null=True, blank=True)  
    type_inf = models.CharField(max_length=50, null=True, blank=True)  
    ...
    code_ssrf = models.CharField(max_length=10, null=True, blank=True)  
    code_orktmo = models.CharField(max_length=11, null=True, blank=True)
    code_ksono = models.CharField(max_length=10, null=True, blank=True) 
    code_knd = models.CharField(max_length=10, null=True, blank=True)  
    date_mg = models.CharField(max_length=10, null=True, blank=True)
